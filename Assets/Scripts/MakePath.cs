...
public class MakePath : MonoBehaviour
{
    ...
    {
        Grower g = new Grower(new Vector2(0, resolution-1), nodes, (0, 5), null, 1, 0);
        ...
        for(int i = 0; i < resolution; i++)
        {
            for(int j = 0; j < resolution; j++)
            {
                if (nodes[j,i] == null)
                {
                    ...
                    if(bruh == 1)
                    {
                        Attractor a = new Attractor(new Vector2(j, i), nodes, (0, 0), 5, 2, null, 1,1);
                        attractors.Add(a);
                        nodes[j, i] = a;
                    }
                }
    ...
    private void CreatePath()
    {
        ...
        foreach (Grower g in influencedNodes)
        {
            ...
            {
                Grower leaf = new Grower(new Vector2(newGrowthPos.x, newGrowthPos.y), nodes, (0, 0), g, 1, 0);
                growers.Add(leaf);
